...
```{r}
ggplot(data = Galton, mapping = aes(x = family, y = father)) + 
  geom_point()
```
2. Seperate your plot into facets by sex.
```{r}
ggplot(data = Galton, mapping = aes(x = family, y = father)) + 
  geom_point()+geom_point(aes(color = sex))
```
3. Add regression lines to all of your facets.
```{r}
ggplot(data = Galton, mapping = aes(x = family, y = father)) + 
  geom_point()+geom_point(aes(color = sex))+geom_lm()
```
...
```{r}
ggplot(data = MLB_teams, mapping = aes(x = yearID, y = WPct)) +geom_point()+geom_point(aes(color = attendance))
